  ...
  private log(logLevel: LogLevel, message: string, ...args: any[]) {
    ...
    switch (logLevel) {
      case LogLevel.Verbose:
        console.log(`[xCore] ${message}`, ...args);
        break;
      case LogLevel.Info:
        // tslint:disable-next-line:no-console
        console.info(`[xCore] ${message}`, ...args);
        break;
      case LogLevel.Warn:
        console.warn(`[xCore] ${message}`, ...args);
        break;
      case LogLevel.Error:
        console.error(`[xCore] ${message}`, ...args);
        break;
      case LogLevel.Critical:
        console.error(`[xCore] [CRITICAL] ${message}`, ...args);
        break;
      default:
        break;
    }
