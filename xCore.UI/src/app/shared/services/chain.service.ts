  ...
  constructor(private log: Logger) {
    ...
    if (!ChainService.singletonInstance) {
      ...
      this.availableChains = [
        { name: 'x42', network: 'x42main', tooltip: 'xCore', networkname: 'Main Network', port: 52342, rpcPort: 52343, apiPort: 42220, wsPort: 42222, genesisDate: new Date(2018, 8, 1) },
        { name: 'x42', network: 'x42test', tooltip: 'xCore (TestNet)', networkname: 'Test Network', port: 62342, rpcPort: 62343, apiPort: 42221, wsPort: 42223, genesisDate: new Date(2020, 6, 6) }
      ];
